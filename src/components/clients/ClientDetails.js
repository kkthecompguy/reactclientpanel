            ...
            <div className="card">
              ...
              <div className="card-body">
                <div className="row">
                  ...
                  <h4 className="pull-right">
                    ...
                    <span className={classnames({
                      ...
                      <small>
                        <a href="#!" onClick={() => this.setState({ showBalanceUpdate: !this.state.showBalanceUpdate})}> <i className="fas fa-pencil-alt"></i> 
                        </a>
                      </small>
                  </h4>
                  {balanceForm}
                ...
                <ul className="list-group">
                  ...
                  <li className="list-group-item">Contact: {client.phone}</li>
                </ul>
              </div>
            </div>   
         </div>
